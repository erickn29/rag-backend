...
from service.user import UserRepoProtocol, UserServiceV1


class UserServiceProtocol(Protocol):
    def __init__(
        self, cache: Cache = cache_service, repo: type[UserRepoProtocol] = UserRepoV1
    ):
        """Init"""
        pass
    ...
    @staticmethod
    def verify_password(plain_password, hashed_password) -> bool:  # type: ignore
...
class AuthService:
    def __init__(
        self,
        user_service: type[UserServiceProtocol] = UserServiceV1, # type: ignore
